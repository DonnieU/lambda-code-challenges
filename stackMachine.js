...
function stackMachine(str) {
  const arr = str.split('');
  const stack = [];
  console.log(Number.parseInt(arr[2]));
  let res;
  console.log(Number.isInteger(arr[2]));
  for (let i = 0; i < arr.length; i++) {
    let curr = Number.parseInt(arr[i]);
...
// }
console.log(stackMachine('13+62*7+*')); // should return 76
console.log(stackMachine('11++')); // should return -1